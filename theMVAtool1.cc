...
int theMVAtool::Draw_Control_Plots_ForPaper()
{
	...
	vector<TH1F*> v_h_line1(6);
	vector<TH1F*> v_h_line2(6);
	vector<TH1F*> v_h_line3(6);

	vector<TText*> v_text1(6);
	vector<TText*> v_text2(6);
	vector<TText*> v_text3(6);

	vector<TGaxis*> v_axis(6);
	...
	for(int iplot=0; iplot<6; iplot++)
	{
		...
		if(iplot==0)
		{
			...
			qw = new TLegend(.07,0.23,0.17,0.47);
		...
		if(v_stack[iplot]!= 0)
		{
			...
			v_stack[iplot]->GetYaxis()->CenterTitle(1);
		...
		v_histo_ratio_data[iplot]->GetYaxis()->SetNdivisions(-6); //grid draw on primary tick marks only //FIXME
		// v_histo_ratio_data[iplot]->GetYaxis()->SetNdivisions(503);


		v_histo_ratio_data[iplot]->SetMinimum(-4.5);
		v_histo_ratio_data[iplot]->SetMaximum(4.5);

		v_histo_ratio_data[iplot]->GetYaxis()->SetLabelSize(0);

		// v_histo_ratio_data[iplot]->SetMinimum(-5); //Ndiv 503
		// v_histo_ratio_data[iplot]->SetMaximum(5);


		// v_histo_ratio_data[iplot]->GetYaxis()->ChangeLabel(1, -1, 0);
		// v_histo_ratio_data[iplot]->GetYaxis()->ChangeLabel(3, -1, 0);
		// v_histo_ratio_data[iplot]->GetYaxis()->ChangeLabel(5, -1, 0);
		// v_histo_ratio_data[iplot]->GetYaxis()->ChangeLabel(7, -1, 0);
		...
		v_axis[iplot] = new TGaxis(v_histo_ratio_data[iplot]->GetXaxis()->GetXmin(),-3,v_histo_ratio_data[iplot]->GetXaxis()->GetXmin(),3,-3,3, 505, "+"); // + : tick marks on positive side ; = : label on same side as marks
   // axis->SetLineColor(1)
		// v_axis[iplot]->SetLabelOffset(-0.05);
	   ...
	   t->SetTextFont(72);
		...
		v_text1[iplot] = new TText(); v_text2[iplot] = new TText(); v_text3[iplot] = new TText();
		// myt->SetTextAlign(32);
		// v_text1[iplot]->SetTextSize(0.05); v_text2[iplot]->SetTextSize(0.05); v_text3[iplot]->SetTextSize(0.05);
		// v_text1[iplot]->DrawText(v_hdata[iplot]->GetXaxis()->GetXmin() - 0.1, 0.05, "test");
		// v_text2[iplot]->DrawText(v_hdata[iplot]->GetXaxis()->GetXmin() - 0.1, 0.1, "test");
		// v_text3[iplot]->DrawText(v_hdata[iplot]->GetXaxis()->GetXmin() - 0.1, 0.15, "test");
	...
	for(int i=0; i<6; i++)
	{
		...
		// delete v_text1[i]; delete v_text2[i]; delete v_text3[i];
	}
...
int theMVAtool::Draw_Control_Plots_ForPaper_WZ()
{
	...
	for(int iplot=0; iplot<3; iplot++)
	{
		...
		if(iplot==0)
		{
			...
			qw = new TLegend(0.5,0.35,0.6,0.83);
			qw->SetShadowColor(0);
			qw->SetFillColor(0);
			qw->SetLineColor(1);
			qw->Draw();
...
int theMVAtool::Postfit_Templates_Paper()
{
	...
	TLegend* qw = 0;
	// qw = new TLegend(.07,0.23,0.18,0.47);
	qw = new TLegend(0.865,0.375,0.965,0.855);
	qw->SetShadowColor(0);
	qw->SetFillColor(0);
	qw->SetLineColor(1);
	qw->Draw();
