...
int main()
{
		...
		name1 = dir + "BDTfiles_noMEM_adaboostneg_amcatnlo/"; label1 = "BDT adaboostneg ttZ amc@nlo";
		name2 = dir + "BDTfiles_noMEM_gradientneg_amcatnlo/"; label2 = "BDTGneg ttZ amc@nlo";
		name3 = dir + "/"; label3 = "BDT adaboostneg ttZ amc@nlo";
		name4 = dir + "/"; label4 = "BDTG ttZ Madgraph";
		name5 = dir + "/"; label5 = "BDT adaboost ttZ Madgraph";
